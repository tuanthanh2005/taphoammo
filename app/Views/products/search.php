                            ...
                            <div class="mb-3 position-relative <?= $i < 2 ? 'border-bottom pb-3' : '' ?>">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="rounded overflow-hidden flex-shrink-0"
                                        ...
                                        <img src="<?= asset($product['thumbnail'] ?? 'images/no-image.png') ?>"
                                            alt="<?= e($product['name']) ?>" class="w-100 h-100" style="object-fit: cover;">
                                    </div>
                                    <div class="ms-2">
                                        <a href="<?= url('/product/' . $product['slug']) ?>"
                                            class="text-dark text-decoration-none fw-medium small hover-primary d-block stretched-link"
                                ...
                                <div class="d-flex justify-content-between text-muted" style="font-size: 11px;">
                                    <span><i class="fas fa-user"></i>
                                        <?= e(Helper::truncate($product['seller_name'], 15)) ?></span>
                                    <span>Đã bán: <strong
                                            class="text-success"><?= $product['total_sold'] ?? 0 ?></strong></span>
                                </div>
                            </div>
                        <?php else: ?>
                            <div class="mb-3 <?= $i < 2 ? 'border-bottom pb-3' : '' ?>">
                                <div class="border border-dashed rounded text-center p-2 bg-light"
                                    style="border: 1px dashed #ced4da !important;">
        ...
        <div class="col-12">
            ...
            <div class="card border-0 shadow-sm mb-4" style="border-radius: 10px; overflow: hidden;">
                <div class="card-body p-1">
                    <form action="<?= url('/search') ?>" method="GET" class="d-flex flex-column flex-md-row w-100 align-items-stretch m-0">
                        <input type="text" name="q" class="form-control border-0 bg-transparent flex-grow-1 px-3 px-md-4 py-2 border-bottom border-md-0"
                            value="<?= e($keyword) ?>" placeholder="Tìm kiếm sản phẩm..."
                            style="box-shadow: none; font-size: 0.95rem;">
                        <button type="submit"
                            class="btn btn-success px-4 rounded border-0 text-nowrap d-flex align-items-center justify-content-center m-1 mt-2 mt-md-1"
            ...
            <!-- Alert -->
            <div
                class="alert text-primary border-primary bg-transparent py-2 px-3 mb-4 d-flex align-items-center rounded-3">
            ...
            <?php if (empty($products)): ?>
                <div class="text-center py-5 bg-white rounded shadow-sm">
                    <img src="<?= asset('images/empty.png') ?>" alt="Empty"
                        style="width: 150px; opacity: 0.5; margin-bottom: 20px;">
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-6">
                            <div class="card h-100 border-0 shadow-sm product-horizontal-card position-relative">
                                <div class="row g-0 p-3 h-100">
                                    <!-- Trái: Hình ảnh & Giá -->
                                    <div
                                        class="col-4 text-center d-flex flex-column justify-content-center align-items-center border-end pe-3">
                                        <div class="product-img-wrap w-100 mb-2 p-2 bg-light rounded d-flex align-items-center justify-content-center"
                                            style="height: 100px;">
                                            <img src="<?= asset($product['thumbnail'] ?? 'images/no-image.png') ?>"
                                                class="img-fluid" alt="<?= e($product['name']) ?>"
                                                style="max-height: 100%; object-fit: contain;">
                                        </div>
                                        <div class="text-success small fw-bold mt-auto">Tồn kho:
                                    ...
                                    <div class="col-8 ps-3 d-flex flex-column">
                                        <h6 class="card-title mb-1" style="line-height: 1.4;">
                                            <span class="badge bg-success me-1 rounded-pill fw-normal"
                                                style="font-size: 10px;">Sản phẩm</span>
                                            <a href="<?= url('/product/' . $product['slug']) ?>"
                                                class="text-dark text-decoration-none hover-primary fw-bold text-uppercase stretched-link">
                                                <?= e($product['name']) ?>
                                            </a>
                                        ...
                                        <div class="text-muted small mb-2 d-flex align-items-center flex-wrap"
                                            ...
                                            <span>Đã bán: <span
                                                    class="text-success fw-bold"><?= $product['total_sold'] ?? 0 ?></span></span>
                                            <span class="mx-1">|</span>
                                        ...
                                        <div class="small mb-1" style="font-size: 12px;">
                                            ...
                                            ?>
                                            <a href="<?= url('/seller/' . rawurlencode($sellerProfileSlug)) ?>"
                                                class="text-decoration-none fw-bold"
                                                style="position: relative; z-index: 2;"><?= e($product['seller_name']) ?></a>
                                            <span class="text-success ms-1"><i class="fas fa-check-circle"
                                                    title="Đã xác thực"></i></span>
                                        </div>
                                        ...
                                        <ul class="small text-muted ps-3 mb-0 mt-auto" style="font-size: 11px;">
                                            <li><?= e(Helper::truncate(strip_tags($product['short_description'] ?? ''), 60)) ?>
                                            </li>
                    ...
                    <nav aria-label="Page navigation" class="mt-4">
                        <ul class="pagination justify-content-end">
                            <?php if ($currentPage > 1): ?>
                                <li class="page-item">
                                    <a class="page-link" href="?page=<?= $currentPage - 1 ?><?= $queryString ?>"><i
                            ...
                            <?php if (count($products) == 20): ?>
                                <li class="page-item">
                                    <a class="page-link" href="?page=<?= $currentPage + 1 ?><?= $queryString ?>">Sau <i
